...
int main(void){
  ...
  while(1){
		...
		if (potentiometer < 768){
			GPIO_PORTF_DATA_R = 0x04; // Blue if less than 300 hz
		}
		else if (potentiometer < 2560){
			GPIO_PORTF_DATA_R = 0x08; // Green if less than 400 hz
		}
		else {
			GPIO_PORTF_DATA_R = 0x02; // Red if greater than 400 hz
		}
